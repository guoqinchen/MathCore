...
pub use crate::stream::{
    BackpressureConfig, BackpressureState, ControlMessage, GraphicsFrameData, ProgressData,
    ProgressStatus, ProofStepData, StepType, StreamBuffer, StreamError, StreamMessage,
...
impl FrameDecoder {
    ...
    pub fn decode(&self, data: &[u8]) -> Result<StreamMessage, StreamError> {
        ...
        match &data[0..4] {
            ...
            b"GFX1" => Ok(StreamMessage::GraphicsFrame(
                self.decode_graphics_frame(data)?,
            )),
            ...
            _ => Err(StreamError::Serialization(
