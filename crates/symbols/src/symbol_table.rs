...
mod tests {
    ...
    fn test_basic_operations() {
        ...
        // Define new symbol
        table
            .define("x", SymbolType::Variable, Some("10".to_string()))
            .unwrap();
    ...
    fn test_scope_isolation() {
        ...
        table
            .define("global_var", SymbolType::Variable, Some("1".to_string()))
            .unwrap();
        ...
        table
            .define("local_var", SymbolType::Variable, Some("2".to_string()))
            .unwrap();
    ...
    fn test_macros() {
        ...
        table
            .define_macro("add", vec!["x".to_string(), "y".to_string()], "$1 + $2")
            .unwrap();

        // Expand macro
        let result = table
            .expand_macro("add", &["1".to_string(), "2".to_string()])
            .unwrap();
