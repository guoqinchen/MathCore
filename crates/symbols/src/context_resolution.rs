...
impl DisambiguationRules {
    ...
    fn init_builtin_rules(&mut self) {
        ...
        self.add_rule('P', Domain::Logic, "Proposition", r"\P", "Propositional variable");
        self.add_rule('P', Domain::Calculus, "Probability", r"\mathbb{P}", "Probability function");
        self.add_rule('P', Domain::LinearAlgebra, "Projection", r"\operatorname{P}", "Projection matrix");
        ...
        self.add_rule('S', Domain::Statistics, "Sample space", r"\mathcal{S}", "Sample space");
        
        // Symbol 'D' - different meanings
        self.add_rule('D', Domain::Calculus, "Differential", "d", "Differential operator");
        self.add_rule('D', Domain::Algebra, "Division", "D", "Division ring");
        
        // Symbol 'I' - different meanings
        self.add_rule('I', Domain::Calculus, "Integral", r"\int", "Integral symbol");
        self.add_rule('I', Domain::LinearAlgebra, "Identity", "I", "Identity matrix");
        self.add_rule('I', Domain::Logic, "Implication", r"\implies", "Logical implication");
        
        // Symbol '∇' - Nabla/Del operator
        self.add_rule('∇', Domain::Calculus, "Gradient", r"\nabla", "Gradient operator");
        self.add_rule('∇', Domain::Geometry, "Laplacian", r"\nabla^2", "Laplacian operator");
        self.add_rule('∇', Domain::LinearAlgebra, "Vector differential", r"\nabla", "Del operator");
    }
    ...
    fn add_rule(&mut self, symbol: char, domain: Domain, meaning: &str, latex: &str, desc: &str) {
        ...
        self.rules.entry(symbol).or_insert_with(Vec::new).push(entry);
    }
...
mod tests {
    ...
    fn test_variable_domain() {
        ...
        assert_eq!(ctx.get_variable_domain("matrix"), Some(Domain::LinearAlgebra));
    }
